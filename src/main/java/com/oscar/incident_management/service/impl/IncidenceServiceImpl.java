...
public class IncidenceServiceImpl implements IncidenceService {
    ...
    @Override
    public List<Incidence> findByTechnicianUsername(String username) {
        User technician = userRepository.findByUsername(username)
                .orElseThrow(() -> new RuntimeException("Usuario no encontrado"));
        return incidenceRepository.findByTechnician(technician);
    }
    ...
    @Override
    public Incidence updateStatus(Long incidenceId, String newStatus) {
        Incidence incidence = incidenceRepository.findById(incidenceId)
                .orElseThrow(() -> new RuntimeException("Incidencia no encontrada"));
